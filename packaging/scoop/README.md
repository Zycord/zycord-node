...
Every URL says `Zycord`, substituted at publication ([RELEASE.md](../../docs/RELEASE.md) §3): a handle in a package URL is published to everyone who installs, and §3's identity audit is easy to run over Go source and easy to forget over a manifest.
