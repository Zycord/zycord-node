...
The public testnet relaunches 2026-09-04 13:00 UTC. Start a node before then
...
**Pre-genesis. The public testnet relaunches 2026-09-04 13:00 UTC; mainnet
...
- [Pool integration surface](docs/POOLS.md) — the Stratum dialect, the blob, the commitment-based target, ExtraNonce, height-derived seed hashes and payouts, for an operator who has integrated Monero-family coins
- [Decision: RandomX v2 at genesis](docs/decisions/randomx-v2.md) — four gates against upstream source, the one that failed, and what shipping anyway cost the header
